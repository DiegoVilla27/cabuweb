...
export default function Projects() {
  ...
  return (
    <section id="proyects" className="px-6 py-32 relative w-full overflow-hidden">
      {/* Background Ambience */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <TitleSection
          titleOne="Nuestros"
          titleTwo="Proyectos"
          text="Navega por las obras maestras digitales que hemos construido. Nuestro equipo calificado de diseñadores de interfaces y desarrolladores de software, siempre están listos para crear algo único para ti."
        />
